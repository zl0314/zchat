...
return [
    ...
    "filePathFormat"=> "/ueditor/php/upload/file/{yyyy}/{mm}/{dd}/{date}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    /* 上传文件配置  文件类型*/
    "voiceActionName"=> "uploadvoice", /* controller里,执行上传视频的action名称 */
    "voiceFieldName"=> "upfile", /* 提交的文件表单名称 */
    "voicePathFormat"=> "/uploads/voice/{yyyy}/{mm}/{dd}/{date}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
    "voiceUrlPrefix"=> "", /* 文件访问路径前缀 */
    "voiceMaxSize"=> 2097152, /* 上传大小限制，单位B，默认2MB */
    "voiceAllowFiles"=> [
       ".mp3",'.avi'
    ], /* 上传文件格式显示 */
